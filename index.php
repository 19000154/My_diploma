    ...
    <!-- main content -->
        <div class="main-content col-md-8 col-12">
            ...
            <!-- <div class="form-check form-switch">
                ...
                <label class="form-check-label" for="flexSwitchCheckDefault"><p id="MapText">карта</p></label>
            </div> -->
                ...
                <!-- <div id="textOrSquare">
                    <p id="additionalText">Этот текст ниже переключателя</p>
                    <p id="loveText" style="display: none;">я люблю тебя</p>
                </div> -->
